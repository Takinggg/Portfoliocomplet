  ...
  if (mode === "checking") {
    return (
      <Alert className="bg-white/5 border-white/10 mb-6">
        ...
        <AlertTitle className="text-white">Vérification...</AlertTitle>
        <AlertDescription className="text-white/60">
          Vérification de la connexion au serveur Supabase
        </AlertDescription>
      </Alert>
    );
  }
  ...
  return (
    <div className="space-y-4 mb-6">
      <Alert className="bg-red-500/10 border-red-500/30">
        ...
        <AlertDescription className="text-white/80">
          Le serveur Supabase Edge Function n'est pas déployé ou inaccessible.
      ...
      <Card className="bg-white/5 border-white/10 p-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            <h3 className="text-white mb-2 flex items-center gap-2">
              <Terminal className="h-5 w-5 text-[#00FFC2]" />
              Comment résoudre ce problème ?
            </h3>
            <p className="text-white/60 text-sm">
              Le serveur Edge Function doit être déployé sur Supabase pour que l'application fonctionne.
            </p>
          </div>
          <Button
        ...
        <div className="space-y-3">
          ...
          >
            <span>
              {showInstructions ? "Masquer" : "Afficher"} les instructions de déploiement
            </span>
          ...
          {showInstructions && (
            <div className="bg-[#0C0C0C] rounded-lg p-4 border border-white/10 space-y-4">
              <div>
                <h4 className="text-white mb-2 text-sm font-medium">Étapes de déploiement :</h4>
                <div className="space-y-3">
                  {/* Step 1 */}
                  <div className="bg-white/5 rounded-lg p-3 space-y-2">
                    <p className="text-white/80 text-sm font-medium">1. Installer Supabase CLI</p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 bg-black/50 text-[#00FFC2] text-xs p-2 rounded border border-white/10 font-mono">
                  ...
                  {/* Step 2 */}
                  <div className="bg-white/5 rounded-lg p-3 space-y-2">
                    <p className="text-white/80 text-sm font-medium">2. Se connecter à Supabase</p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 bg-black/50 text-[#00FFC2] text-xs p-2 rounded border border-white/10 font-mono">
                        supabase login
                      </code>
                  ...
                  {/* Step 4 */}
                  <div className="bg-white/5 rounded-lg p-3 space-y-2">
                    <p className="text-white/80 text-sm font-medium">4. Déployer le serveur</p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 bg-black/50 text-[#00FFC2] text-xs p-2 rounded border border-white/10 font-mono">
                  ...
                  {/* Step 5 */}
                  <div className="bg-white/5 rounded-lg p-3 space-y-2">
                    <p className="text-white/80 text-sm font-medium">5. Vérifier le déploiement</p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 bg-black/50 text-[#00FFC2] text-xs p-2 rounded border border-white/10 font-mono overflow-x-auto whitespace-nowrap">
              ...
              <div className="pt-3 border-t border-white/10">
                <p className="text-white/60 text-xs">
                  📖 Guide complet disponible dans <code className="text-[#00FFC2]">/DEPLOYMENT_GUIDE_SUPABASE.md</code>
                </p>
              </div>
            </div>
          )}
