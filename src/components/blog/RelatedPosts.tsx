      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-[#CCFF00]/20 to-[#DAFF40]/20 border border-[#CCFF00]/30 rounded-lg">
              <Sparkles className="h-5 w-5 text-[#CCFF00]" />
            </div>
            <div>
              <h2 className="text-2xl text-white">Articles similaires</h2>
              <p className="text-sm text-white/40 mt-1">
                Continuez votre lecture avec ces articles recommand̩s
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <button
            ...
            className="inline-flex items-center gap-2 text-[#CCFF00] hover:text-[#DAFF40] transition-colors group"
          >
