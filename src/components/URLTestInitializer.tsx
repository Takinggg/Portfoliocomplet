...
export const URLTestInitializer = () => {
  useEffect(() => {
    ...
    console.log('%c║      ✅ UTILITAIRES URLS CHARGÉS AVEC SUCCÈS                  ║', 'color: #00FFC2; font-weight: bold;');
    console.log('%c╚════════════════════════════════════════════════════════════════╝', 'color: #00FFC2; font-weight: bold;');
    console.log('');
    console.log('%c🎮 Commandes disponibles:', 'color: #F4F4F4; font-weight: bold; font-size: 14px;');
    console.log('');
    console.log('%cwindow.testAllURLs.printAllRoutes()', 'color: #00FFC2; font-size: 13px; font-family: monospace; background: #0C0C0C; padding: 4px 8px;');
    console.log('   ➜ Affiche toutes les URLs (FR + EN)');
    console.log('');
    console.log('%cwindow.testAllURLs.showURLStructure()', 'color: #00FFC2; font-size: 13px; font-family: monospace; background: #0C0C0C; padding: 4px 8px;');
    console.log('   ➜ Vue arborescente des URLs');
    console.log('');
    console.log('%cwindow.testAllURLs.allRoutes', 'color: #00FFC2; font-size: 13px; font-family: monospace; background: #0C0C0C; padding: 4px 8px;');
    console.log('   ➜ Tableau de toutes les routes');
    console.log('');
    console.log('═══════════════════════════════════════════════════════════════');
