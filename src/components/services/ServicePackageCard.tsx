...
export function ServicePackageCard({ package: pkg, index, onAuditClick }: ServicePackageCardProps) {
  ...
  return (
    <>
      ...
      >
        {pkg.recommended ? (
          <div className="relative h-full rounded-2xl border border-mint bg-mint/5 hover:border-mint/40 transition-all duration-300 overflow-hidden">
            {/* Glow effect */}
          ...
          <div className="relative h-full rounded-2xl border border-neutral-900 bg-neutral-950/50 hover:border-mint/40 transition-all duration-300 overflow-hidden">
            <div className="relative p-8">
              {/* Header */}
              <div className="mb-6">
                <h3 className="text-3xl font-bold mb-2 group-hover:text-mint transition-colors">
