...
export const emailTemplates = {
  ...
  bookingUpdate: (data: {
    ...
    subject: "ðŸ“… Modification de votre rendez-vous",
    html: `
      <!DOCTYPE html>
      <html>
        <head>
          ...
          <style>
            ...
            .new-date { background: #e8f5e9; color: #2e7d32; font-weight: bold; border: 2px solid #CCFF00; }
            .arrow { font-size: 24px; color: #666; }
            .info-box { background: white; border-left: 4px solid #CCFF00; padding: 20px; margin: 20px 0; border-radius: 4px; }
          </style>
        </head>
        <body>
          <div class="container">
            <div class="header">
              <h1 style="margin: 0; font-size: 28px;">ðŸ“… Rendez-vous modifiÃ©</h1>
            </div>
            <div class="content">
              <p>Bonjour <strong>${data.name}</strong>,</p>
              
              <p>Votre rendez-vous${data.service ? ` pour <strong>${data.service}</strong>` : ''} a Ã©tÃ© dÃ©placÃ© :</p>
              ...
              <div class="info-box">
                <p style="margin: 0;"><strong>ðŸ“‹ RÃ©capitulatif :</strong></p>
              ...
              <p>Si vous avez des questions ou si cette modification ne vous convient pas, n'hÃ©sitez pas Ã  nous contacter.</p>
            ...
            <div class="footer">
              <p style="margin: 0;">Â© 2025 FOULON Maxence - DÃ©veloppeur Web Freelance</p>
              <p style="margin: 5px 0 0 0; opacity: 0.8;">Cet email a Ã©tÃ© envoyÃ© automatiquement suite Ã  une modification de rendez-vous.</p>
            </div>
          </div>
        </body>
      </html>
    `,
    text: `Bonjour ${data.name},\n\nVotre rendez-vous${data.service ? ` pour ${data.service}` : ''} a Ã©tÃ© dÃ©placÃ© :\n\nAncienne date : ${data.oldDate} Ã  ${data.time}\nNouvelle date : ${data.newDate} Ã  ${data.time}\n\nSi vous avez des questions ou si cette modification ne vous convient pas, n'hÃ©sitez pas Ã  nous contacter.\n\nÃ€ bientÃ´t,\nVotre Freelance`
  }),
