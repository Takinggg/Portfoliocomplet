...
# 🧹 SCRIPT DE NETTOYAGE - Supprime tous les fichiers de debug
...
FILES_TO_DELETE=(
  ...
  "PROBLEME_RESOLU.md"
  "PUSH_FIX_MAINTENANT.txt"
  "PUSH_MAINTENANT.txt"
  "QUEL_GUIDE_CHOISIR.md"
  "README_FIX_404.md"
  "README_HASH_ROUTING.md"
...
echo "📦 Ton projet est maintenant propre"
