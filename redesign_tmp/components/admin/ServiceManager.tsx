  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-center">
        <div>
            <h1 className="text-3xl font-display font-bold text-white mb-2">Services & Pricing</h1>
            <p className="text-neutral-400">Manage your offer packages.</p>
        </div>
          ...
          {services.map(service => (
              <div key={service.id} className={`bg-[#0F0F0F] border rounded-xl p-6 flex flex-col ${editingId === service.id ? 'border-primary' : 'border-white/5'}`}>
                  ...
                  <div className="space-y-4 flex-grow">
                      <div>
                          <label className="text-xs text-neutral-500 uppercase">Title ({lang})</label>
                      ...
                      <div>
                          <label className="text-xs text-neutral-500 uppercase">Price ({lang})</label>
                           {editingId === service.id ? (
                              <input 
                                type="text" 
                      ...
                      <div>
                           <label className="text-xs text-neutral-500 uppercase mb-2 block">Features ({lang})</label>
