      ...
      `}>
          <div className="p-8 border-b border-white/5">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-full w-fit border border-white/5">
                  ...
                  <span className="text-[10px] font-mono text-neutral-400 uppercase tracking-widest">System Online</span>
              </div>
          </div>

          <nav className="p-6 space-y-1 flex-1 overflow-y-auto">
              <div className="text-xs font-mono text-neutral-600 uppercase tracking-widest mb-4 px-4">Main Menu</div>
